...
{	
	...
	//lucy.build_input(0, 20); 						// Cria 256 entradas iniciais no modelo 0
	//lucy.build_hidden(0, 10);						// Cria 128 neurônios na 1ª camada oculta do modelo 0
	//lucy.build_hidden(0, 5);						// Cria 64 neurônios na 2ª camada oculta do modelo 0
